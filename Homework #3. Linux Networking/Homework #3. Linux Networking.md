...
#### 2. [На Server_1 налаштувати DHCP сервіс, який буде конфігурувати адреси Int1 Client_1 та Client_2](## Here is the network schema
![This is a alt text.](/Screenshots/networking_1.png "networking")
...
`Client_1 - CentOS`. Налаштуємо int1(`enp0s8 - Net_2`) та одразу int2(`enp0s9 - Net_4`) Создамо та налаштуємо конфігураційні файли для кожного інтерфейса, це є особливістю CentOS мати конф. файл для кожного мережевого інтерфейсу. Командаю `cat` виведемо налаштування в термінал.
